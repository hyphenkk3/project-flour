-- Smallest follow-up to 20260818120000_guest_preorder_options.sql
-- Live submit failed: column reference "addon" is ambiguous
--
-- Cause: PL/pgSQL variable `addon` collided with the SQL alias
--   from jsonb_array_elements(p_paid_addons) addon
-- in the paid-add-on jsonb_agg. FOR-loop assignment to `addon` is unchanged.
--
-- Safe replace of submit_guest_preorder only. Signature unchanged
-- (p_complimentary, p_paid_addons). No catalogue, Extra, or confirmation changes.
