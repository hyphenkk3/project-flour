-- Customer Whole Cake physical receipt request.
-- Smallest compatible change to submit_guest_preorder:
-- add p_include_receipt (default false) and persist orders.include_receipt.
-- Independent of email_submission_receipt_requested.
-- Does not change catalogue, Extra, pickup, or confirmation wording.
