-- Staff guest create: optional dine-in via existing _sync_order_fulfilment_from_payload.
-- Owner pickup/delivery callers omit p_dine_in (default null). Website submit_guest_preorder unchanged.
...
comment on function public.create_staff_guest_preorder(
  ...
  'Staff-created guest preorder. Optional p_paid_addons (default []). '
  'Optional p_fulfilment_method (default pickup), p_delivery, and p_dine_in. '
  'Pickup/delivery callers omit p_dine_in. Dine-in reuses _sync_order_fulfilment_from_payload. '
