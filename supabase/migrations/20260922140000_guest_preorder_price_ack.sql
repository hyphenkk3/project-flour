-- Guest preorder cake-size price acknowledgement.
-- Website checkout must send p_price_ack when quoted price differs from
-- library_cake_size_price_on. Legacy callers that omit p_price_ack still
-- charge the resolver price. Fresh Picks / EXTRA are unchanged.
