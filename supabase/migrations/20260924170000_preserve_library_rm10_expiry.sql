-- Preserve Voucher Library registered expiry during RM10 redemption.
-- The redeem form expiry is still stored on order_adjustments.metadata
-- and physical_discount_voucher_redemptions. It must not overwrite a
-- library_managed physical_discount_vouchers.expiry_date.
-- Unregistered/historical first-time inserts still use p_expiry_date.
-- Owner Override is unchanged.
