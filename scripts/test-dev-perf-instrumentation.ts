...
assert.match(checkoutPerfSrc, /CheckoutReceivedShellProbe/);
assert.match(checkoutPerfSrc, /received_shell/);
assert.match(checkoutPerfSrc, /confirmToReceivedShellMs/);
assert.match(checkoutPerfSrc, /committed_order_received_shell/);
assert.match(clientHelperSrc, /SUCCESS_RECEIVED_SHELL/);
assert.match(formSrc, /CheckoutReceivedShellProbe flow="preorder"/);
assert.match(extraFormSrc, /CheckoutReceivedShellProbe flow="extra"/);
...
assert.match(actionsSrc, /logPerf\("CHECKOUT_DATE", "date_confirmation"/);
assert.match(actionsSrc, /runWithCheckoutDatePerf/);
assert.match(clientHelperSrc, /CHECKOUT_DATE/);
assert.match(clientHelperSrc, /logCheckoutDateConfirmationWaterfall/);
