...
assert.match(cardSrc, /aspect-\[2\/1\]/);
assert.match(cardSrc, /object-cover/);
assert.match(cardSrc, /object-center/);
assert.match(cardSrc, /p-2\.5/);
assert.match(cardSrc, /gap-2\.5/);
assert.match(cardSrc, /mb-1\.5/);
assert.doesNotMatch(cardSrc, /aspect-\[16\/7\]/);
