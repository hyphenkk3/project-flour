...
assert.match(uiSrc, /Waiting List/);
assert.match(uiSrc, /new customer request/);
assert.match(uiSrc, /View Waiting List/);
...
assert.match(liveSrc, /waiting_list_new_request/);
assert.match(liveSrc, /staff_notification_events/);
