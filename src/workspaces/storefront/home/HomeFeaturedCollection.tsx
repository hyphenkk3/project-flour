  ...
  return (
    <section className="border-ink/[0.1] mt-8 border-t px-6 pt-8">
      ...
      {previewCakes.length > 0 ? (
        <div className="-mx-6 mt-4 overflow-x-auto overscroll-x-contain [scrollbar-width:none] [&::-webkit-scrollbar]:hidden">
          <ul className="flex w-max gap-3 px-6 pr-8">
              ...
              return (
                <li className="w-[8.5rem] shrink-0" key={cake.id}>
                  <Link className="group block" href={href}>
                    <div className="relative aspect-square w-[8.5rem] overflow-hidden rounded-[10px]">
                      {photo?.url ? (
                        <CakePhotoImage
