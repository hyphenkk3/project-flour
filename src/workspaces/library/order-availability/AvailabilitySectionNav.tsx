...
const tabClass =
  "border-fog text-ink hover:border-skyline inline-flex min-h-11 items-center justify-center rounded-lg border bg-white px-3 text-sm font-medium";

export function AvailabilitySectionNav() {
  return (
    <nav
      aria-label="Availability sections"
      className="border-fog bg-mist/95 sticky top-16 z-20 -mx-1 flex flex-wrap gap-2 px-1 py-2"
    >
